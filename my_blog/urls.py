...
from home.views import home_view,success_view
...
urlpatterns = [
    ...
    path('password-reset-complete/',auth_views.PasswordResetCompleteView.as_view(template_name='users/complete.html') ,name = 'password_reset_complete'),
